 ...
 * @author Magento
 */
class Magentostudy_Stores_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
    ...
    /**
     * Return the base media directory for Stores Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Stores Item images
     *
     * @return string
     */
    ...
    /**
     * Remove stores item image by image filename
     *
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('magentostudy_stores')->__('Uploaded image is not valid'));
            }
     ...
     *
     * @param Magentostudy_Stores_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(Magentostudy_Stores_Model_Stores $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
