...
class Magentostudy_News_Block_Adminhtml_News_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        if (Mage::helper('magentostudy_news/admin')->isActionAllowed('save')) {
            $this->_updateButton('save', 'label', Mage::helper('magentostudy_news')->__('Save Press Item'));
        ...
        if (Mage::helper('magentostudy_news/admin')->isActionAllowed('delete')) {
            $this->_updateButton('delete', 'label', Mage::helper('magentostudy_news')->__('Delete Press Item'));
        } else {
    ...
    public function getHeaderText()
    {
        ...
        if ($model->getId()) {
            return Mage::helper('magentostudy_news')->__("Edit Press Item '%s'",
                 $this->escapeHtml($model->getTitle()));
        } else {
            return Mage::helper('magentostudy_news')->__('New Press Item');
        }
    }
}