    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('image_main', 'image', array(
            'name'      => 'image_main',
            'label'     => Mage::helper('magentostudy_news')->__('Image - MAIN'),
            'title'     => Mage::helper('magentostudy_news')->__('Image - MAIN'),
            'required'  => false,
            'disabled'  => $isElementDisabled
        ));

        $fieldset->addField('image_popup', 'image', array(
            'name'      => 'image_popup',
            'label'     => Mage::helper('magentostudy_news')->__('Image - POPUP'),
            'title'     => Mage::helper('magentostudy_news')->__('Image - POPUP'),
            'required'  => false,
            'disabled'  => $isElementDisabled
        ));
