...
class ParadoxLabs_AuthorizeNetCim_Block_Profilelink extends Mage_Core_Block_Template
{
	public function addProfileLink() {
	    if( ($parentBlock = $this->getParentBlock()) && Mage::getModel('authnetcim/payment')->getConfigData('active') ) {
	        $parentBlock->addLink("Manage My Cards", 'authnetcim/manage/', "Manage My Cards", true, array(), 50, null);
	    }
	}
}
