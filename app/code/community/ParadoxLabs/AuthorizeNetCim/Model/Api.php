...
//					<customerType>'. $this->getParameter('customerType').'</customerType>
	...
	{
		return isset($this->results[4]) ? str_replace( '"', '', $this->results[4] ) : false;
	}
	...
	{
		return isset($this->results[6]) ? str_replace( '"', '', $this->results[6] ) : false;
	}
	...
	{
		return isset($this->results[50]) ? substr( str_replace( '"', '', $this->results[50] ), -4 ) : '';
	}
	...
	public function getCcType()
	{
		...
		if( isset($this->results[51]) && isset( $types[ str_replace( '"', '', $this->results[51] ) ] ) ) {
			return $types[ str_replace( '"', '', $this->results[51] ) ];
		}
		else {
			return '';
		}
