 ...
 * File path:   app/code/local/Aitoc/Aitpreorder/Model/Catalog/Product/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpreorder')){ NQIOagYehympNwgq('7d42edd47b9b2e59357a91e573cf5f96'); ?><?php
class Aitoc_Aitpreorder_Model_Catalog_Product_Observer extends Mage_Core_Model_Abstract
{
