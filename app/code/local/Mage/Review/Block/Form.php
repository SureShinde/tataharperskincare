...
class Mage_Review_Block_Form extends Mage_Core_Block_Template
{
    ...
    public function getProductInfoReviewPage()
    {
        // Custom AX 4.25.13
        // For use on formcustom.phtml - forces product ID to be "Review Product" (53)
        $product = Mage::getModel('catalog/product');
        return $product->load(53);
    }
    ...
    public function getActionReviewPage()
    {
        // Custom AX 4.25.13
        // For use on formcustom.phtml - forces product ID to be "Review Product" (53)
        $productId = 53;
