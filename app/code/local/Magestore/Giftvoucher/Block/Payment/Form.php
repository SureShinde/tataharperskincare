...
class Magestore_Giftvoucher_Block_Payment_Form extends Mage_Payment_Block_Form
{
	...
	public function getGrandTotal(){
		if (!$this->hasData('grand_total')){
            ...
            $grandTotal += $quote->getCustomerBalanceAmountUsed() + $quote->getRewardCurrencyAmount();
			/*
    ...
    public function getGiftVoucherAmount() {
        $session = Mage::getSingleton('checkout/session');
        return $session->getBaseGiftVoucherDiscount() + $session->getBaseUseGiftCreditAmount();
    }
}
